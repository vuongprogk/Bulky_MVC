...
public class OrderController : Controller
{
    ...
    public IActionResult Details(int orderId)
    {
        OrderVM = new()
        {
            OrderHeader = _unitOfWork.OrderHeaderRepository.GetFirstOrDefault(
                o => o.Id == orderId,
    ...
    {
        var orderHeaderFromDb = _unitOfWork.OrderHeaderRepository.GetFirstOrDefault(o =>
            o.Id == OrderVM.OrderHeader.Id
        );
    ...
    {
        var orderHeader = _unitOfWork.OrderHeaderRepository.GetFirstOrDefault(o =>
            o.Id == OrderVM.OrderHeader.Id
        );
    ...
    [ActionName("Details")]
    [HttpPost]
    public IActionResult Payment_Now()
    {
        ...
        {
            SuccessUrl =
                domain + $"admin/order/PaymentComfirmation?orderHeaderId={OrderVM.OrderHeader.Id}",
    ...
    public IActionResult PaymentComfirmation(int orderHeaderId)
    {
    ...
    public IActionResult GetAll(string status)
    {
        ...
        if (User.IsInRole(SD.Role_Admin) || User.IsInRole(SD.Role_Employee))
        {
            orderHeaders = _unitOfWork
                .OrderHeaderRepository.GetAll(includeProperties: "ApplicationUser")
                .ToList();
        }
        else
        {
        ...
        switch (status)
        {
            case "paymentpending":
                orderHeaders = orderHeaders.Where(x =>
                    x.PaymentStatus == SD.PaymentStatusDeTayedPayment
                );
                break;
            case "inprocess":
